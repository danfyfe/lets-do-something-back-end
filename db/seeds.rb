...
# users ##
dan = User.create(username:'Dan Theman', password: '123', email:'fyfedaniel@gmail.com' )

meylin = User.create(username:'Meylin', password:'123', email:'meylinlopez08@gmail.com')
